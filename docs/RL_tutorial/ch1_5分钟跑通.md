...
这与社区里大部分"Agentic RL"教程不同——后者多是 **GSM8K + Calculator** / **MATH + Python REPL** 这类 *单步、verifier 判分* 设置，本质只是 RLVR，不算真 agentic。详细辨析见教程 [§ 数据集章节](../2026-06-08_agentic_rl_v22_tutorial.md#2-数据集这才是真正的-agentic-rl-任务)。
